...
public class SubAttachment {
  ...
  **/
  ...
  public SubAttachment signerIndex(Integer signerIndex) {
   ...
   /**
   * The signer&#39;s unique number, see &#x60;signers[%i%][name]&#x60; for more details.  **NOTE**: Only one signer can be assigned per attachment.
   * @return signerIndex
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The signer's unique number, see `signers[%i%][name]` for more details.  **NOTE**: Only one signer can be assigned per attachment.")
