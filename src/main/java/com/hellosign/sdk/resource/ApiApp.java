...
public class ApiApp extends AbstractResource {
     ...
     *
     * NOTE: This Account object will only have the owner's account ID and email address. All other
     * values will be null.
     *
     * @return Account
     */
    ...
    /**
     * Internal method used to retrieve the necessary POST fields to submit the API app to
     * HelloSign.
     *
     * @return Map
    ...
    public Map<String, Serializable> getPostFields() throws HelloSignException {
        ...
        try {
            ...
            if (white_labeling_options != null) {
                fields.put(WhiteLabelingOptions.WHITE_LABELING_OPTIONS_KEY,
                    white_labeling_options.toString(0));
            }
        } catch (Exception e) {
